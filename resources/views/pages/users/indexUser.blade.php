...
<style>
  .destination-hero {
    background: url('https://static.vecteezy.com/system/resources/thumbnails/056/635/668/small/black-office-with-computer-desk-and-plants-photo.jpeg') center/cover no-repeat;
    position: relative;
    padding: 100px 0;
    margin-bottom: 40px;
  }
...
<section class="destination-hero text-white text-center">
  <div class="container">
    <h1>Data User</h1>
    <p>Manage your user data efficiently</p>
  </div>
</section>
...
<section class="pb-5">
  <div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
      <h2 class="section-title mb-0">Semua User</h2>

      <form action="/user" method="GET" class="search-form d-flex align-items-center gap-2">
        <input type="text" name="search" class="form-control" placeholder="Cari user..." value="{{ request('search') }}">
        <i class="bi bi-search search-icon"></i>
        <button type="submit" class="btn">Cari</button>
      </form>

      <a href="/user/create" class="btn-add ms-3">
            ...
            <tr>
              ...
              <td>
                ...
                <div class="action-buttons">
                  ...
                  <a href="{{ route('user.edit', $user->id) }}" class="btn-update">
