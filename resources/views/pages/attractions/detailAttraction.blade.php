...
<section class="pb-5">
  <div class="container">
    <div class="detail-card">
      <h2><i class="bi bi-info-circle-fill text-primary"></i> Informasi Atraksi</h2>
        ...
        <div class="col-12">
          <div class="info-item">
            ...
            <div class="info-content">
              ...
              <div class="info-value">{{ $attraction->description }}</div>
            </div>
          </div>
          ...
          <div class="info-item">
            ...
            <div class="info-content">
              ...
              <div class="info-value">{{ $attraction->created_at }}</div>
            </div>
          </div>
          ...
          <div class="info-item">
            ...
            <div class="info-content">
              ...
              <div class="info-value">{{ $attraction->updated_at }}</div>
            </div>
          </div>
